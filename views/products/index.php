                ...
                <div class="col-md-12">
                    <form>
                        <h4 class="pull-left filter">
                            Price: <a href="?filter=price&direction=asc" class="btn btn-default"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i> Low</i></a> <a href="?filter=price&direction=desc" class="btn btn-default"><i class="fa fa-sort-numeric-desc" aria-hidden="true"> High</i></a>&emsp;|&ensp;
